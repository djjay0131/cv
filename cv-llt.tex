...
\makerubric{build/\cvvariant/tex/summary}

\makerubric{build/\cvvariant/tex/employment}
\makerubric{build/\cvvariant/tex/education}
\makerubric{build/\cvvariant/tex/projects}

% Publications are rendered by biblatex directly from own-bib.bib; see publications.tex.
\input{publications}

\makerubric{build/\cvvariant/tex/skills}
\makerubric{build/\cvvariant/tex/misc}

\makerubric{build/\cvvariant/tex/referee}
